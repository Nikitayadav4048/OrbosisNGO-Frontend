...
const SignupPage = () => {
          ...
          <CardContent className="space-y-4 sm:space-y-6 relative px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                {data === "Donor" ? (
  // ✅ Show a fixed disabled dropdown (non-interactive)
  ...
  <Select value={formData.role} onValueChange={handleRoleChange}>
    ...
    <SelectContent className="z-[60] bg-white border border-gray-200 rounded-md shadow-lg">
      ...
      <SelectItem value="volunteer" className="bg-white hover:bg-gray-50 text-sm">
        Volunteer
      </SelectItem>
      <SelectItem value="donor" className="bg-white hover:bg-gray-50 text-sm">
        Donor
      </SelectItem>
      <SelectItem value="beneficiary" className="bg-white hover:bg-gray-50 text-sm">
        Beneficiary
      </SelectItem>
    </SelectContent>
  </Select>
